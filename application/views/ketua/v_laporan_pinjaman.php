...
<?php if ($this->session->flashdata('pesan_sukses')) : ?>
      <div class="row">
        ...
        <div class="alert alert-success alert-dismissible fade show" role="alert">
          <div class="col-6">
              Data Pinjaman<strong> Berhasil</strong> <?= $this->session->flashdata('pesan_sukses'); ?>
...
<?php elseif ($this->session->flashdata('pesan_error')) : ?>
      <div class="row">
        ...
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
          <div class="col-6">
              Data Pinjaman<strong> Gagal</strong> <?= $this->session->flashdata('pesan_error'); ?>
...
<div style="margin-bottom: 1%;" class="container col">
  <a id="formButton1" href="#" class="btn-sm"><i class="fa fa-eye"></i> Lihat Semua Pinjaman Anggota</a>
</div>
  ...
  <div class="row">
    <div class="col-lg-6">
      ...
      <div class="card p-2  shadow-sm">
        ...
        <hr>
        <form action="<?= base_url('ketua/lihat_pinjaman_all') ?>" method="post">
          <div class="form-row">
...
<div style="margin-top: 3%;margin-bottom: 1%;" class="container col">
  <a id="formButton" href="#" class="btn-sm"><i class="fa fa-eye"></i> Lihat Pinjaman Per Anggota</a>
</div>
  ...
  <div class="row">
    <div class="col-lg-6">
      ...
      <div class="card p-2  shadow-sm">
        ...
        <hr>
        <form action="<?= base_url('ketua/lihat_pinjaman_a') ?>" method="post">
          <div class="form-row">
            <div class="form-group col-lg-12">
