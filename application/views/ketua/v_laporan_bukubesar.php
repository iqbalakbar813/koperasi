...
<div class="row mb-2 mb-sm-0 mb-xl-2">
	...
	<?php endif ?>
		...
		<form method="post" action="<?= base_url();?>ketua/cetak_bb" target="_blank">
	...
	<div class="col-12 col-sm-4 col-md-4 col-xl-1">
        	<a class="btn btn-danger" href="<?= base_url();?>ketua/buku_besar">Reset</a>
	</div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$('#kode_akun').on('input',function(){
                ...
                $.ajax({
                    type : "POST",
                    url  : "<?php echo base_url('index.php/ketua/get_kodeakun')?>",
                    dataType : "JSON",
