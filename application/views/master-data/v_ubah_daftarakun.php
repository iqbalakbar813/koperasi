            ...
            <div class="form-row">
               <div class="form-group col-lg-6">
                      ...
                      <div class="form-group col-lg-6">
                        ...
                        <?php elseif ($daftar_akun['pos_laporan'] == 'Laporan Perhitungan Hasil Usaha') : ?>
                        ...
                        <h5 style="display: block;" id="pos_label_labarugi">Pos Akun Laporan Perhitungan Hasil Usaha</h5>
