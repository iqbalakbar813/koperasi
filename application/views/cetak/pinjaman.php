	...
	<div id="header">
			...
			<div>
				<table cellspacing="0">
					...
					<tr>
						<th width="50%">Total Pinjaman Posisi Per 31 Desember <?= $tahun ?></th>
                        <th width="50%">Total Sisa Pinjaman Posisi Per 31 Desember <?= $tahun ?></th>
					</tr>
					<tr class="tengah">
				...
				<table style="margin-top: 2%;" cellspacing="0">
					...
					<?php foreach ($anggota as $da ) : ?>
                        <tr>
                          ...
                          <td><?= rupiah2($da['sisa_pinjaman']) ?></td>
                        </tr>
                        <?php endforeach; ?>
				</table>
			</div>
