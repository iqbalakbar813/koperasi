...
#header{
	...
	<div id="header">
				...
				<h2 style="margin-top: 2px; margin-bottom: 0px;">Laporan SHU</h2>
			...
			<?php endif ?>
							...
							<tr class="bg-dark text-white" >
									...
									<?php if (!empty($jumlah_pajak)): ?>
										<td>Sisa Hasil Usaha Setelah Pajak Per Desember <?= $tahun?></td>
									
									<?php else: ?>
										<td>Sisa Hasil Usaha Per Desember <?= $tahun?></td>
